...
def draw():
    ...
    try:
        ...
        if ("ending" + str(bgaNum).zfill(4) + ".jpg") in bga_files:
            if prevNum == bgaNum:
                screen.blit(bgmImage, bgmImage.get_rect())
            else:
                bgmImage = pygame.image.load("ending\\" + "ending" + str(bgaNum).zfill(4) + ".jpg")
...
running = True
sounds.Sound("C:/Users/psych/Desktop/Outro/ending.wav").play()
